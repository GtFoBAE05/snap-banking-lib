...
type briAccessTokenRequest struct {
	GrantType string `json:"grantType"`
}

type briAccessTokenResponse struct {
...
func (a *BRIAdapter) GetAccessToken(ctx context.Context) (*model.AccessToken, error) {
	ctx, span := utils.StartSpan(ctx, a.tracer, model.BankBRI.Name(), "GetAccessToken")
	defer span.End()
	...
	requestBody := briAccessTokenRequest{
	...
	var resp briAccessTokenResponse
