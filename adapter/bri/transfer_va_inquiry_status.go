...
type briVirtualAccountInquiryStatusRequest struct {
...
type briVirtualAccountInquiryStatusBillDetail struct {
...
type briVirtualAccountInquiryStatusData struct {
	...
	BillDetails       []briVirtualAccountInquiryStatusBillDetail `json:"billDetails"`
}

type briVirtualAccountInquiryStatusResponse struct {
	ResponseCode       string                              `json:"responseCode"`
	ResponseMessage    string                              `json:"responseMessage"`
	VirtualAccountData *briVirtualAccountInquiryStatusData `json:"virtualAccountData"`
}

func (a *BRIAdapter) GetVirtualAccountInquiryStatus(ctx context.Context, accessToken string, request *model.VirtualAccountInquiryStatusRequest) (*model.VirtualAccountInquiryStatusResponse, error) {
	ctx, span := utils.StartSpan(ctx, a.tracer, model.BankBRI.Name(), "GetVirtualAccountInquiryStatus")
	defer span.End()
	...
	requestBody := briVirtualAccountInquiryStatusRequest{
	...
	var resp briVirtualAccountInquiryStatusResponse
	...
	return briVirtualAccountInquiryStatusResponseToModel(resp), nil
}

func briVirtualAccountInquiryStatusResponseToModel(briResp briVirtualAccountInquiryStatusResponse) *model.VirtualAccountInquiryStatusResponse {
