...
type bcaVirtualAccountInquiryRequest struct {
...
type bcaLocalizedText struct {
	English   string `json:"english"`
	Indonesia string `json:"indonesia"`
}

type bcaBillDetail struct {
...
type bcaAdditionalInfoItem struct {
	Label *bcaLocalizedText `json:"label"`
	Value *bcaLocalizedText `json:"value"`
}

type bcaVirtualAccountData struct {
	InquiryStatus         string                           `json:"inquiryStatus"`
	InquiryReason         *bcaLocalizedText                `json:"inquiryReason"`
	PartnerServiceId      string                           `json:"partnerServiceId"`
	CustomerNo            string                           `json:"customerNo"`
	VirtualAccountNo      string                           `json:"virtualAccountNo"`
	...
	BillDetails           []bcaBillDetail                  `json:"billDetails"`
...
type bcaVirtualAccountInquiryResponse struct {
	ResponseCode       string                 `json:"responseCode"`
	ResponseMessage    string                 `json:"responseMessage"`
	VirtualAccountData *bcaVirtualAccountData `json:"virtualAccountData"`
}

func (a *BCAAdapter) GetVirtualAccountInquiry(ctx context.Context, accessToken string, request *model.VirtualAccountInquiryRequest) (*model.VirtualAccountInquiryResponse, error) {
	ctx, span := utils.StartSpan(ctx, a.tracer, model.BankBCA.Name(), "GetVirtualAccountInquiry")
	defer span.End()
	...
	requestBody := bcaVirtualAccountInquiryRequest{
	...
	var resp bcaVirtualAccountInquiryResponse
	...
	return bcaVirtualAccountInquiryResponseToModel(resp), nil
}

func bcaVirtualAccountInquiryResponseToModel(bcaResp bcaVirtualAccountInquiryResponse) *model.VirtualAccountInquiryResponse {
	...
	modelResp.VirtualAccountData = &model.VirtualAccountData{
		...
		InquiryReason:         parseLocalizedText(data.InquiryReason),
...
func parseLocalizedText(t *bcaLocalizedText) *model.LocalizedText {
	if t == nil {
		return nil
	}
